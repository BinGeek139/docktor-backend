...
public class TokenProvider {
    ...
    public boolean validateToken(String authToken) {
        try {
            ...
            Optional<Subscriber> optionalSubscriber=subscriberRepository.findFirstByToken(authToken);
            if(!optionalSubscriber.isPresent()){
                throw new DuplicateTokenException(Constants.MESSAGE_DUPLICATE_TOKEN);
            }
            return true;
    ...
    private void validateDuplicateToken(String jwt){
