package com.techasians.doctor.user.system.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("usersystem");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("usersystem");
        ...
        config.getMapConfigs().put("com.techasians.doctor.user.system.domain.*", initializeDomainMapConfig(jHipsterProperties));
