...
@RestController
@RequestMapping("/api/management-kafka")
public class ManagementKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ManagementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ManagementKafkaResource(KafkaProperties kafkaProperties) {
